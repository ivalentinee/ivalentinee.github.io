...
uid: redux-saga-tester-redux-form
---
...
И приспичило мне в [саге](https://github.com/redux-saga/redux-saga) сделать изменение в состоянии [redux-form](https://redux-form.com/). Соединим всё это с моим стремлением к [написанию всего через тесты]({% uid_url TDD %}), и приехали. Всё сломалось.
