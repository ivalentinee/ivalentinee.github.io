...
No "I use stealth!", no "I want to roll for perception" – your players are numb, their characters are out of their control, and you're the [alpha and omega](https://en.wikipedia.org/wiki/Alpha_and_Omega).
...
They can put a __request__ for their character to do something, then *(not all the time, but still)* they throw the dice *~~under the table and look for it for the next 10 minutes~~* and determine (with your guidance) what is the outcome of their request.\\
...
What if everything happens not because you told it to, but because that's what the [stones of chance](https://youtu.be/xGVC6-Bohqk) decided is the outcome of your __request__?\\
...
You have no way to lose control – *~~you're no [Teddy Swims](https://youtu.be/GZ3zL7kT6_c)~~* can't lose what you don't have.\\
...
Now, this sort of gameplay requires *(somewhat)* to have a rules-heavy system, so you can lean back and watch the rules do the governing while you play the game like the rest of the table. *I heard [Fate](https://en.wikipedia.org/wiki/Fate_(role-playing_game_system)) guys have a remedy for that.*
...
A good friend of mine told me that even renowned and experienced authors lose control of their worlds soon after book publication – and I don't mean legal stuff, but rather shifting a perspective from the demiurge of the world to a humble beholder *(not [that one](https://en.wikipedia.org/wiki/Beholder_(Dungeons_%26_Dragons)), you nerd)*.
...
Shouldn't we ~~ab~~use it as much as possible?
